...
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
	...
	('def', 'yzk', 'acos', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	('def', 'yzk', 'acos', 'parent_id', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'acos', 'model', 3, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'acos', 'foreign_key', 4, NULL, 'YES', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'acos', 'alias', 5, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'acos', 'lft', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'acos', 'rght', 7, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'aros', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	('def', 'yzk', 'aros', 'parent_id', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'aros', 'model', 3, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'aros', 'foreign_key', 4, NULL, 'YES', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'aros', 'alias', 5, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'aros', 'lft', 6, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'aros', 'rght', 7, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'aros_acos', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	('def', 'yzk', 'aros_acos', 'aro_id', 2, NULL, 'NO', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', 'MUL', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'aros_acos', 'aco_id', 3, NULL, 'NO', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'aros_acos', '_create', 4, '0', 'NO', 'varchar', 2, 6, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(2)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'aros_acos', '_read', 5, '0', 'NO', 'varchar', 2, 6, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(2)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'aros_acos', '_update', 6, '0', 'NO', 'varchar', 2, 6, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(2)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'aros_acos', '_delete', 7, '0', 'NO', 'varchar', 2, 6, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(2)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'campaigns', 'id', 1, NULL, 'YES', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'campaigns', 'campaign_yn_id', 2, NULL, 'YES', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'campaigns', 'day_lim', 3, '0', 'YES', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'campaigns', 'modified', 4, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'campaigns', 'created', 5, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'clients', 'id', 1, '', 'NO', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', 'PRI', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'clients', 'user_id', 2, NULL, 'YES', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'clients', 'agent_id', 3, NULL, 'YES', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'clients', 'ynname', 4, NULL, 'YES', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'clients', 'pass', 5, NULL, 'YES', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'clients', 'created', 6, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'clients', 'modified', 7, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'details', 'id', 1, NULL, 'NO', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', 'PRI', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'details', 'user_id', 2, NULL, 'NO', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'details', 'position', 3, '1', 'NO', 'float', NULL, NULL, 12, NULL, NULL, NULL, 'float', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'details', 'field', 4, NULL, 'NO', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(255)', 'MUL', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'details', 'value', 5, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'details', 'input', 6, NULL, 'NO', 'varchar', 16, 48, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(16)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'details', 'data_type', 7, NULL, 'NO', 'varchar', 16, 48, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(16)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'details', 'label', 8, NULL, 'NO', 'varchar', 128, 384, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(128)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'details', 'created', 9, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'details', 'modified', 10, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'groups', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
	('def', 'yzk', 'groups', 'name', 2, NULL, 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'modes', 'id', 1, '', 'NO', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', 'PRI', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'modes', 'body', 2, NULL, 'YES', 'varchar', 256, 768, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(256)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'modes', 'created', 3, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'modes', 'modified', 4, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'phrases', 'id', 1, '', 'NO', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', 'PRI', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'phrases', 'agent_id', 2, '', 'NO', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'phrases', 'banner_yn_id', 3, NULL, 'YES', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'phrases', 'campaing_yn_id', 4, NULL, 'YES', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'phrases', 'phrase_yn_id', 5, NULL, 'YES', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'phrases', 'text', 6, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'phrases', 'price', 7, NULL, 'YES', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'phrases', 'mode', 8, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'phrases', 'mode_x', 9, NULL, 'YES', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'phrases', 'modified', 10, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'phrases', 'created', 11, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'users', 'id', 1, '', 'NO', 'varchar', 36, 108, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(36)', 'PRI', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'users', 'group_id', 2, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'users', 'password', 3, NULL, 'YES', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(64)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'users', 'key', 4, NULL, 'YES', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(32)', 'UNI', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'users', 'email', 5, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', 'UNI', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'users', 'username', 6, NULL, 'YES', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'users', 'last_login', 7, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'users', 'created', 8, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', ''),
	('def', 'yzk', 'users', 'modified', 9, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', '');
...
INSERT INTO `GLOBAL_STATUS` (`VARIABLE_NAME`, `VARIABLE_VALUE`) VALUES
	...
	('HANDLER_READ_KEY', '397'),
	('HANDLER_READ_LAST', '0'),
	('HANDLER_READ_NEXT', '0'),
	('HANDLER_READ_PREV', '0'),
	('HANDLER_READ_RND', '0'),
	('HANDLER_READ_RND_NEXT', '11650'),
	('HANDLER_ROLLBACK', '0'),
	('HANDLER_SAVEPOINT', '0'),
	...
	('INNODB_BUFFER_POOL_PAGES_FREE', '2599'),
	('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
	('INNODB_BUFFER_POOL_PAGES_TOTAL', '3008'),
	('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
	('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
	('INNODB_BUFFER_POOL_READ_REQUESTS', '42262'),
	('INNODB_BUFFER_POOL_READS', '405'),
	('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
	('INNODB_BUFFER_POOL_WRITE_REQUESTS', '510'),
	('INNODB_DATA_FSYNCS', '97'),
	('INNODB_DATA_PENDING_FSYNCS', '0'),
	('INNODB_DATA_PENDING_READS', '0'),
	('INNODB_DATA_PENDING_WRITES', '0'),
	('INNODB_DATA_READ', '8818688'),
	('INNODB_DATA_READS', '415'),
	('INNODB_DATA_WRITES', '220'),
	('INNODB_DATA_WRITTEN', '4769280'),
	...
	('THREADS_RUNNING', '1'),
	('UPTIME', '30197'),
	('UPTIME_SINCE_FLUSH_STATUS', '30197');
...
INSERT INTO `GLOBAL_VARIABLES` (`VARIABLE_NAME`, `VARIABLE_VALUE`) VALUES
	...
	('PID_FILE', 'C:\\Documents and Settings\\All Users\\Application Data\\MySQL\\MySQL Server 5.5\\Data\\kondrat.pid'),
	...
	('FLUSH_TIME', '1800'),
	('GENERAL_LOG_FILE', 'C:\\Documents and Settings\\All Users\\Application Data\\MySQL\\MySQL Server 5.5\\Data\\kondrat.log'),
	('HAVE_INNODB', 'YES'),
	...
	('SYSTEM_TIME_ZONE', 'Arabian Standard Time'),
	...
	('SLOW_QUERY_LOG_FILE', 'C:\\Documents and Settings\\All Users\\Application Data\\MySQL\\MySQL Server 5.5\\Data\\kondrat-slow.log'),
	...
	('LOG_ERROR', 'C:\\Documents and Settings\\All Users\\Application Data\\MySQL\\MySQL Server 5.5\\Data\\kondrat.err'),
...
INSERT INTO `KEY_COLUMN_USAGE` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `POSITION_IN_UNIQUE_CONSTRAINT`, `REFERENCED_TABLE_SCHEMA`, `REFERENCED_TABLE_NAME`, `REFERENCED_COLUMN_NAME`) VALUES
	...
	('def', 'yzk', 'PRIMARY', 'def', 'yzk', 'acos', 'id', 1, NULL, NULL, NULL, NULL),
	('def', 'yzk', 'PRIMARY', 'def', 'yzk', 'aros', 'id', 1, NULL, NULL, NULL, NULL),
	('def', 'yzk', 'PRIMARY', 'def', 'yzk', 'aros_acos', 'id', 1, NULL, NULL, NULL, NULL),
	('def', 'yzk', 'ARO_ACO_KEY', 'def', 'yzk', 'aros_acos', 'aro_id', 1, NULL, NULL, NULL, NULL),
	('def', 'yzk', 'ARO_ACO_KEY', 'def', 'yzk', 'aros_acos', 'aco_id', 2, NULL, NULL, NULL, NULL),
	('def', 'yzk', 'PRIMARY', 'def', 'yzk', 'clients', 'id', 1, NULL, NULL, NULL, NULL),
	('def', 'yzk', 'PRIMARY', 'def', 'yzk', 'details', 'id', 1, NULL, NULL, NULL, NULL),
	('def', 'yzk', 'UNIQUE_PROFILE_PROPERTY', 'def', 'yzk', 'details', 'field', 1, NULL, NULL, NULL, NULL),
	('def', 'yzk', 'UNIQUE_PROFILE_PROPERTY', 'def', 'yzk', 'details', 'user_id', 2, NULL, NULL, NULL, NULL),
	('def', 'yzk', 'PRIMARY', 'def', 'yzk', 'groups', 'id', 1, NULL, NULL, NULL, NULL),
	('def', 'yzk', 'PRIMARY', 'def', 'yzk', 'modes', 'id', 1, NULL, NULL, NULL, NULL),
	('def', 'yzk', 'PRIMARY', 'def', 'yzk', 'phrases', 'id', 1, NULL, NULL, NULL, NULL),
	('def', 'yzk', 'PRIMARY', 'def', 'yzk', 'users', 'id', 1, NULL, NULL, NULL, NULL),
	('def', 'yzk', 'key', 'def', 'yzk', 'users', 'key', 1, NULL, NULL, NULL, NULL),
	('def', 'yzk', 'email', 'def', 'yzk', 'users', 'email', 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `PARTITIONS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `PARTITION_NAME`, `SUBPARTITION_NAME`, `PARTITION_ORDINAL_POSITION`, `SUBPARTITION_ORDINAL_POSITION`, `PARTITION_METHOD`, `SUBPARTITION_METHOD`, `PARTITION_EXPRESSION`, `SUBPARTITION_EXPRESSION`, `PARTITION_DESCRIPTION`, `TABLE_ROWS`, `AVG_ROW_LENGTH`, `DATA_LENGTH`, `MAX_DATA_LENGTH`, `INDEX_LENGTH`, `DATA_FREE`, `CREATE_TIME`, `UPDATE_TIME`, `CHECK_TIME`, `CHECKSUM`, `PARTITION_COMMENT`, `NODEGROUP`, `TABLESPACE_NAME`) VALUES
	...
	('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, NULL, '', '', NULL),
	...
	('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, NULL, '', '', NULL),
	...
	('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, NULL, '', '', NULL),
	('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, NULL, '', '', NULL),
	...
	('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, NULL, '', '', NULL),
	...
	('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, NULL, '', '', NULL),
	...
	('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, NULL, '', '', NULL),
	...
	('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', '2011-01-21 08:18:29', NULL, '', '', NULL),
	('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-01-21 08:18:29', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
	('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 453, 197, 89241, 55450570411999231, 16384, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 992, 9, 8928, 2533274790395903, 18432, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 505, 829, 418712, 281474976710655, 20480, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-01-21 08:18:29', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2011-01-21 08:18:29', '2011-01-21 05:18:30', '2011-01-21 08:18:29', NULL, '', '', NULL),
	('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
	('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, NULL, '', '', NULL),
	('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 78, 364, 281474976710655, 2048, 208, '2011-01-21 08:18:28', '2011-03-01 10:58:13', NULL, NULL, '', '', NULL),
	...
	('def', 'yzk', 'acos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2011-03-07 20:19:16', NULL, NULL, NULL, '', '', NULL),
	('def', 'yzk', 'aros', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2011-03-07 20:19:16', NULL, NULL, NULL, '', '', NULL),
	('def', 'yzk', 'aros_acos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2011-03-07 20:19:16', NULL, NULL, NULL, '', '', NULL),
	('def', 'yzk', 'campaigns', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 2048, 16384, NULL, 0, 0, '2011-03-03 11:55:20', NULL, NULL, NULL, '', '', NULL),
	('def', 'yzk', 'clients', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 25, 655, 16384, NULL, 0, 0, '2011-03-03 11:55:20', NULL, NULL, NULL, '', '', NULL),
	('def', 'yzk', 'details', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2011-03-03 11:55:20', NULL, NULL, NULL, '', '', NULL),
	('def', 'yzk', 'groups', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 0, 0, '2011-03-03 11:55:20', NULL, NULL, NULL, '', '', NULL),
	('def', 'yzk', 'modes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2011-03-12 10:00:14', NULL, NULL, NULL, '', '', NULL),
	('def', 'yzk', 'phrases', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 24, 682, 16384, NULL, 0, 0, '2011-03-14 22:07:55', NULL, NULL, NULL, '', '', NULL),
	('def', 'yzk', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 28, 585, 16384, NULL, 32768, 0, '2011-03-03 11:55:21', NULL, NULL, NULL, '', '', NULL);
...
INSERT INTO `PLUGINS` (`PLUGIN_NAME`, `PLUGIN_VERSION`, `PLUGIN_STATUS`, `PLUGIN_TYPE`, `PLUGIN_TYPE_VERSION`, `PLUGIN_LIBRARY`, `PLUGIN_LIBRARY_VERSION`, `PLUGIN_AUTHOR`, `PLUGIN_DESCRIPTION`, `PLUGIN_LICENSE`, `LOAD_OPTION`) VALUES
	('binlog', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50509.0', NULL, NULL, 'MySQL AB', 'This is a pseudo storage engine to represent the binlog in a transaction', 'GPL', 'FORCE'),
	...
	('CSV', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50509.0', NULL, NULL, 'Brian Aker, MySQL AB', 'CSV storage engine', 'GPL', 'FORCE'),
	('MEMORY', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50509.0', NULL, NULL, 'MySQL AB', 'Hash based, stored in memory, useful for temporary tables', 'GPL', 'FORCE'),
	('MyISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50509.0', NULL, NULL, 'MySQL AB', 'MyISAM storage engine', 'GPL', 'FORCE'),
	('MRG_MYISAM', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50509.0', NULL, NULL, 'MySQL AB', 'Collection of identical MyISAM tables', 'GPL', 'FORCE'),
	('ARCHIVE', '3.0', 'ACTIVE', 'STORAGE ENGINE', '50509.0', NULL, NULL, 'Brian Aker, MySQL AB', 'Archive storage engine', 'GPL', 'ON'),
	('BLACKHOLE', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50509.0', NULL, NULL, 'MySQL AB', '/dev/null storage engine (anything you write to it disappears)', 'GPL', 'ON'),
	('FEDERATED', '1.0', 'DISABLED', 'STORAGE ENGINE', '50509.0', NULL, NULL, 'Patrick Galbraith and Brian Aker, MySQL AB', 'Federated MySQL storage engine', 'GPL', 'OFF'),
	('InnoDB', '1.1', 'ACTIVE', 'STORAGE ENGINE', '50509.0', NULL, NULL, 'Innobase Oy', 'Supports transactions, row-level locking, and foreign keys', 'GPL', 'ON'),
	('INNODB_TRX', '1.1', 'ACTIVE', 'INFORMATION SCHEMA', '50509.0', NULL, NULL, 'Innobase Oy', 'InnoDB transactions', 'GPL', 'ON'),
	('INNODB_LOCKS', '1.1', 'ACTIVE', 'INFORMATION SCHEMA', '50509.0', NULL, NULL, 'Innobase Oy', 'InnoDB conflicting locks', 'GPL', 'ON'),
	('INNODB_LOCK_WAITS', '1.1', 'ACTIVE', 'INFORMATION SCHEMA', '50509.0', NULL, NULL, 'Innobase Oy', 'InnoDB which lock is blocking which', 'GPL', 'ON'),
	('INNODB_CMP', '1.1', 'ACTIVE', 'INFORMATION SCHEMA', '50509.0', NULL, NULL, 'Innobase Oy', 'Statistics for the InnoDB compression', 'GPL', 'ON'),
	('INNODB_CMP_RESET', '1.1', 'ACTIVE', 'INFORMATION SCHEMA', '50509.0', NULL, NULL, 'Innobase Oy', 'Statistics for the InnoDB compression; reset cumulated counts', 'GPL', 'ON'),
	('INNODB_CMPMEM', '1.1', 'ACTIVE', 'INFORMATION SCHEMA', '50509.0', NULL, NULL, 'Innobase Oy', 'Statistics for the InnoDB compressed buffer pool', 'GPL', 'ON'),
	('INNODB_CMPMEM_RESET', '1.1', 'ACTIVE', 'INFORMATION SCHEMA', '50509.0', NULL, NULL, 'Innobase Oy', 'Statistics for the InnoDB compressed buffer pool; reset cumulated counts', 'GPL', 'ON'),
	('PERFORMANCE_SCHEMA', '0.1', 'ACTIVE', 'STORAGE ENGINE', '50509.0', NULL, NULL, 'Marc Alff, Oracle', 'Performance Schema', 'GPL', 'FORCE'),
	('partition', '1.0', 'ACTIVE', 'STORAGE ENGINE', '50509.0', NULL, NULL, 'Mikael Ronstrom, MySQL AB', 'Partition Storage Engine Helper', 'GPL', 'ON');
...
INSERT INTO `PROCESSLIST` (`ID`, `USER`, `HOST`, `DB`, `COMMAND`, `TIME`, `STATE`, `INFO`) VALUES
	(15, 'root', 'localhost:4758', 'yzk', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST` LIMIT 0, 104857600');
...
INSERT INTO `SCHEMATA` (`CATALOG_NAME`, `SCHEMA_NAME`, `DEFAULT_CHARACTER_SET_NAME`, `DEFAULT_COLLATION_NAME`, `SQL_PATH`) VALUES
	...
	('def', 'yzk', 'utf8', 'utf8_general_ci', NULL);
...
INSERT INTO `SESSION_STATUS` (`VARIABLE_NAME`, `VARIABLE_VALUE`) VALUES
	...
	('BINLOG_STMT_CACHE_DISK_USE', '0'),
	('BINLOG_STMT_CACHE_USE', '0'),
	('BYTES_RECEIVED', '14752'),
	('BYTES_SENT', '95858'),
	('COM_ADMIN_COMMANDS', '191'),
	('COM_ASSIGN_TO_KEYCACHE', '0'),
	('COM_ALTER_DB', '0'),
	('COM_ALTER_DB_UPGRADE', '0'),
	('COM_ALTER_EVENT', '0'),
	...
	('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
	('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
	('INNODB_BUFFER_POOL_READ_REQUESTS', '42556'),
	('INNODB_BUFFER_POOL_READS', '405'),
	('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
	('INNODB_BUFFER_POOL_WRITE_REQUESTS', '510'),
	('INNODB_DATA_FSYNCS', '97'),
...
INSERT INTO `STATISTICS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `NON_UNIQUE`, `INDEX_SCHEMA`, `INDEX_NAME`, `SEQ_IN_INDEX`, `COLUMN_NAME`, `COLLATION`, `CARDINALITY`, `SUB_PART`, `PACKED`, `NULLABLE`, `INDEX_TYPE`, `COMMENT`, `INDEX_COMMENT`) VALUES
	...
	('def', 'yzk', 'acos', 0, 'yzk', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'yzk', 'aros', 0, 'yzk', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'yzk', 'aros_acos', 0, 'yzk', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'yzk', 'aros_acos', 0, 'yzk', 'ARO_ACO_KEY', 1, 'aro_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'yzk', 'aros_acos', 0, 'yzk', 'ARO_ACO_KEY', 2, 'aco_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'yzk', 'clients', 0, 'yzk', 'PRIMARY', 1, 'id', 'A', 25, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'yzk', 'details', 0, 'yzk', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'yzk', 'details', 0, 'yzk', 'UNIQUE_PROFILE_PROPERTY', 1, 'field', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'yzk', 'details', 0, 'yzk', 'UNIQUE_PROFILE_PROPERTY', 2, 'user_id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'yzk', 'groups', 0, 'yzk', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'yzk', 'modes', 0, 'yzk', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'yzk', 'phrases', 0, 'yzk', 'PRIMARY', 1, 'id', 'A', 24, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'yzk', 'users', 0, 'yzk', 'PRIMARY', 1, 'id', 'A', 28, NULL, NULL, '', 'BTREE', '', ''),
	('def', 'yzk', 'users', 0, 'yzk', 'key', 1, 'key', 'A', 2, NULL, NULL, 'YES', 'BTREE', '', ''),
	('def', 'yzk', 'users', 0, 'yzk', 'email', 1, 'email', 'A', 28, NULL, NULL, 'YES', 'BTREE', '', '');
...
INSERT INTO `TABLES` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `TABLE_TYPE`, `ENGINE`, `VERSION`, `ROW_FORMAT`, `TABLE_ROWS`, `AVG_ROW_LENGTH`, `DATA_LENGTH`, `MAX_DATA_LENGTH`, `INDEX_LENGTH`, `DATA_FREE`, `AUTO_INCREMENT`, `CREATE_TIME`, `UPDATE_TIME`, `CHECK_TIME`, `TABLE_COLLATION`, `CHECKSUM`, `CREATE_OPTIONS`, `TABLE_COMMENT`) VALUES
	...
	('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, 'utf8_general_ci', NULL, 'max_rows=3153', ''),
	...
	('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, 'utf8_general_ci', NULL, 'max_rows=696', ''),
	...
	('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, 'utf8_general_ci', NULL, 'max_rows=6806', ''),
	('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, 'utf8_general_ci', NULL, 'max_rows=6276', ''),
	('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, 'utf8_general_ci', NULL, 'max_rows=12744', ''),
	('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, 'utf8_general_ci', NULL, 'max_rows=26886', ''),
	...
	('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, 'utf8_general_ci', NULL, 'max_rows=656', ''),
	...
	('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, 'utf8_general_ci', NULL, 'max_rows=640', ''),
	...
	('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-05-29 17:39:46', '2011-05-29 17:39:46', NULL, 'utf8_general_ci', NULL, 'max_rows=7802', ''),
	...
	('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
	('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', '2011-01-21 08:18:29', 'utf8_bin', NULL, '', 'Database privileges'),
	('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-01-21 08:18:29', '2011-01-21 05:18:30', NULL, 'utf8_general_ci', NULL, '', 'Events'),
	('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
	('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
	('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
	('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 453, 197, 89241, 55450570411999231, 16384, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
	('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 992, 9, 8928, 2533274790395903, 18432, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
	('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 505, 829, 418712, 281474976710655, 20480, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
	('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
	('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-01-21 08:18:29', '2011-01-21 05:18:30', NULL, 'latin1_swedish_ci', NULL, '', ''),
	('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
	('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
	('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
	('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2011-01-21 08:18:29', '2011-01-21 05:18:30', '2011-01-21 08:18:29', 'utf8_bin', NULL, '', 'User proxy privileges'),
	('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
	('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
	('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
	('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
	('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
	('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
	('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
	('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2011-01-21 08:18:28', '2011-01-21 05:18:30', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
	('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 78, 364, 281474976710655, 2048, 208, NULL, '2011-01-21 08:18:28', '2011-03-01 10:58:13', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
	...
	('def', 'yzk', 'acos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 6291456, 1, '2011-03-07 20:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'row_format=COMPACT', ''),
	('def', 'yzk', 'aros', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 6291456, 1, '2011-03-07 20:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'row_format=COMPACT', ''),
	('def', 'yzk', 'aros_acos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 6291456, 1, '2011-03-07 20:19:16', NULL, NULL, 'utf8_general_ci', NULL, 'row_format=COMPACT', ''),
	('def', 'yzk', 'campaigns', 'BASE TABLE', 'InnoDB', 10, 'Compact', 8, 2048, 16384, 0, 0, 6291456, NULL, '2011-03-03 11:55:20', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	('def', 'yzk', 'clients', 'BASE TABLE', 'InnoDB', 10, 'Compact', 25, 655, 16384, 0, 0, 6291456, NULL, '2011-03-03 11:55:20', NULL, NULL, 'utf8_general_ci', NULL, 'row_format=COMPACT', ''),
	('def', 'yzk', 'details', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 6291456, NULL, '2011-03-03 11:55:20', NULL, NULL, 'utf8_general_ci', NULL, 'row_format=COMPACT', ''),
	('def', 'yzk', 'groups', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 0, 6291456, 5, '2011-03-03 11:55:20', NULL, NULL, 'utf8_general_ci', NULL, 'row_format=COMPACT', ''),
	('def', 'yzk', 'modes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 6291456, NULL, '2011-03-12 10:00:14', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	('def', 'yzk', 'phrases', 'BASE TABLE', 'InnoDB', 10, 'Compact', 24, 682, 16384, 0, 0, 6291456, NULL, '2011-03-14 22:07:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
	('def', 'yzk', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 28, 585, 16384, 0, 32768, 6291456, NULL, '2011-03-03 11:55:21', NULL, NULL, 'utf8_general_ci', NULL, 'row_format=COMPACT', '');
...
INSERT INTO `TABLE_CONSTRAINTS` (`CONSTRAINT_CATALOG`, `CONSTRAINT_SCHEMA`, `CONSTRAINT_NAME`, `TABLE_SCHEMA`, `TABLE_NAME`, `CONSTRAINT_TYPE`) VALUES
	...
	('def', 'yzk', 'PRIMARY', 'yzk', 'acos', 'PRIMARY KEY'),
	('def', 'yzk', 'PRIMARY', 'yzk', 'aros', 'PRIMARY KEY'),
	('def', 'yzk', 'PRIMARY', 'yzk', 'aros_acos', 'PRIMARY KEY'),
	('def', 'yzk', 'ARO_ACO_KEY', 'yzk', 'aros_acos', 'UNIQUE'),
	('def', 'yzk', 'PRIMARY', 'yzk', 'clients', 'PRIMARY KEY'),
	('def', 'yzk', 'PRIMARY', 'yzk', 'details', 'PRIMARY KEY'),
	('def', 'yzk', 'UNIQUE_PROFILE_PROPERTY', 'yzk', 'details', 'UNIQUE'),
	('def', 'yzk', 'PRIMARY', 'yzk', 'groups', 'PRIMARY KEY'),
	('def', 'yzk', 'PRIMARY', 'yzk', 'modes', 'PRIMARY KEY'),
	('def', 'yzk', 'PRIMARY', 'yzk', 'phrases', 'PRIMARY KEY'),
	('def', 'yzk', 'PRIMARY', 'yzk', 'users', 'PRIMARY KEY'),
	('def', 'yzk', 'key', 'yzk', 'users', 'UNIQUE'),
	('def', 'yzk', 'email', 'yzk', 'users', 'UNIQUE');
...
# Dumping data for table mysql.help_keyword: 453 rows
...
# Dumping data for table mysql.help_relation: 992 rows
...
# Dumping data for table mysql.help_topic: 505 rows
...
# Dumping data for table mysql.proxies_priv: 1 rows
...
INSERT INTO `proxies_priv` (`Host`, `User`, `Proxied_host`, `Proxied_user`, `With_grant`, `Grantor`, `Timestamp`) VALUES
	('localhost', 'root', '', '', 1, '', '2011-01-21 08:18:29');
...
DELETE FROM `events_waits_history_long`;
...
# Dumping data for table performance_schema.setup_consumers: 8 rows
...
# Dumping data for table performance_schema.setup_timers: 1 rows
DELETE FROM `setup_timers`;
...
INSERT INTO `campaigns` (`id`, `campaign_yn_id`, `day_lim`, `modified`, `created`) VALUES
	('4de244da-1404-4778-95e5-01789be3e0a3', '2768795', 1234, '2011-05-29 13:06:34', '2011-05-29 13:06:34'),
	('4de2474f-fbf0-4ae1-af47-01789be3e0a3', '2216207', 555, '2011-05-29 13:17:03', '2011-05-29 13:17:03'),
	('4de247fc-8498-44af-898b-01789be3e0a3', '1642647', 111, '2011-05-29 13:19:56', '2011-05-29 13:19:56'),
	('4de24855-33cc-434b-a952-01789be3e0a3', '1643555', 222, '2011-05-29 13:21:25', '2011-05-29 13:21:25'),
	('4de24976-136c-454a-9393-01789be3e0a3', '2939329', 333, '2011-05-29 13:26:14', '2011-05-29 13:26:14'),
	('4de249ae-71fc-4f6b-bf38-01789be3e0a3', '3007781', 444, '2011-05-29 13:27:10', '2011-05-29 13:27:10'),
	('4de24a7c-d1e4-4974-85af-01789be3e0a3', '3508345', 123, '2011-05-29 13:30:36', '2011-05-29 13:30:36'),
	('4de24c34-aa70-4a74-9442-01789be3e0a3', '2071551', 33, '2011-05-29 13:37:56', '2011-05-29 13:37:56');
...
# Dumping data for table yzk.clients: ~25 rows (approximately)
DELETE FROM `clients`;
...
INSERT INTO `clients` (`id`, `user_id`, `agent_id`, `ynname`, `pass`, `created`, `modified`) VALUES
	...
	('4d877db9-cbfc-48ff-82a0-025c9be3e0a3', '4d877db9-0458-43e6-9b39-025c9be3e0a3', '4d5f015f-86b0-4b91-b79a-045b9be3e0a3', 'tsteel-dir', 'trecedrore', '2011-03-21 16:32:57', '2011-03-21 16:32:57'),
	('4d87a347-f594-463d-b080-025c9be3e0a3', '4d87a347-bae8-4efe-b0c3-025c9be3e0a3', '4d5f015f-86b0-4b91-b79a-045b9be3e0a3', 'sv-capital', 'procrowali', '2011-03-21 19:13:11', '2011-03-21 19:13:11'),
	('4d87a438-ad8c-4910-846b-025c9be3e0a3', '4d87a438-d168-4acc-91f5-025c9be3e0a3', '4d5f015f-86b0-4b91-b79a-045b9be3e0a3', 'medolina2009', 'ueclihitru', '2011-03-21 19:17:12', '2011-03-21 19:17:12'),
	('4d87a48a-8f8c-4d32-95b9-025c9be3e0a3', '4d87a48a-e504-4e87-a3bc-025c9be3e0a3', '4d5f015f-86b0-4b91-b79a-045b9be3e0a3', 'svservis2010', 'komusleben', '2011-03-21 19:18:34', '2011-03-21 19:18:34'),
	('4d87a979-6520-4275-ae1a-025c9be3e0a3', '4d87a979-2b58-4da5-8604-025c9be3e0a3', '4d5f015f-86b0-4b91-b79a-045b9be3e0a3', 'vavilonsv', 'fresatapet', '2011-03-21 19:39:37', '2011-03-21 19:39:37'),
	('4d87aa60-7284-47f0-aedb-025c9be3e0a3', '4d87aa60-ce3c-4297-81a9-025c9be3e0a3', '4d5f015f-86b0-4b91-b79a-045b9be3e0a3', 'vrmoto', 'cliphajoce', '2011-03-21 19:43:28', '2011-03-21 19:43:28'),
	('4d87ab98-f5ec-468c-963d-025c9be3e0a3', '4d87ab98-43f8-41e4-92b1-025c9be3e0a3', '4d5f015f-86b0-4b91-b79a-045b9be3e0a3', 'mechty10', '1234', '2011-03-21 19:48:40', '2011-03-21 19:48:40');
...
# Dumping data for table yzk.phrases: ~24 rows (approximately)
DELETE FROM `phrases`;
...
INSERT INTO `phrases` (`id`, `agent_id`, `banner_yn_id`, `campaing_yn_id`, `phrase_yn_id`, `text`, `price`, `mode`, `mode_x`, `modified`, `created`) VALUES
	('4da20be3-1060-4977-b836-04bc9be3e0a3', '', '22256950', '3287542', '219796179', NULL, 2, 'minPlusP', 2, '2011-04-11 07:43:19', '2011-04-10 19:58:27'),
	('4da20be3-14e4-4f3d-8d9e-04bc9be3e0a3', '', '22256950', '3287542', '219796173', NULL, 2, 'minPlusP', 2, '2011-04-11 07:43:19', '2011-04-10 19:58:27'),
	('4da20be3-48f8-4802-aa03-04bc9be3e0a3', '', '22256950', '3287542', '219796175', NULL, 2, 'minPlusP', 2, '2011-04-11 07:43:19', '2011-04-10 19:58:27'),
	('4da20be3-5cb8-4f07-a7de-04bc9be3e0a3', '', '22256950', '3287542', '219796167', NULL, 2, 'minPlusP', 2, '2011-04-11 07:43:19', '2011-04-10 19:58:27'),
	('4da20be3-6e90-4106-ba98-04bc9be3e0a3', '', '22256950', '3287542', '219796177', NULL, 2, 'minPlusP', 2, '2011-04-11 07:43:19', '2011-04-10 19:58:27'),
	('4da20be3-a378-43db-9275-04bc9be3e0a3', '', '22256950', '3287542', '219796171', NULL, 2, 'minPlusP', 2, '2011-04-11 07:43:19', '2011-04-10 19:58:27'),
	('4da20be3-cb60-4a45-bd8d-04bc9be3e0a3', '', '22256950', '3287542', '219796178', NULL, 2, 'minPlusP', 2, '2011-04-11 07:43:19', '2011-04-10 19:58:27'),
	('4da20db2-85e0-4295-8edc-04bc9be3e0a3', '', '4335358', '1643555', '44532288', NULL, 111, 'premMaxMinusC', 111, '2011-04-10 20:28:18', '2011-04-10 20:06:10'),
	('4da20db2-f564-4e7c-934e-04bc9be3e0a3', '', '4335358', '1643555', '44532293', NULL, 111, 'premMaxMinusC', 111, '2011-04-10 20:28:18', '2011-04-10 20:06:10'),
	('4da2104a-4440-4fc3-96b7-04bc9be3e0a3', '', '4335358', '1643555', '44532292', NULL, 111, 'premMaxMinusC', 111, '2011-04-10 20:28:18', '2011-04-10 20:17:14'),
	('4da2104a-a578-45b8-8725-04bc9be3e0a3', '', '4335358', '1643555', '44532291', NULL, 111, 'premMaxMinusC', 111, '2011-04-10 20:28:18', '2011-04-10 20:17:14'),
	('4da212c5-1870-4253-ae27-04bc9be3e0a3', '', '4335358', '1643555', '44532289', NULL, 111, 'premMaxMinusC', 111, '2011-04-10 20:28:18', '2011-04-10 20:27:49'),
	('4da2a520-3314-4c8c-b490-02549be3e0a3', '', '16798734', '1967353', '159027933', NULL, 2, 'minPlusP', 2, '2011-04-11 06:52:32', '2011-04-11 06:52:16'),
	('4da2a530-69f8-4e53-8522-02549be3e0a3', '', '16798734', '1967353', '159027937', NULL, 2, 'minPlusP', 2, '2011-04-11 06:52:32', '2011-04-11 06:52:32'),
	('4da2a5e5-f3e8-42d3-b2a0-02549be3e0a3', '', '16797182', '1967343', '159020379', NULL, 2, 'minPlusP', 2, '2011-04-11 07:07:14', '2011-04-11 06:55:33'),
	('4da2b116-22ac-4d31-a734-02549be3e0a3', '', '22256950', '3287542', '219796169', NULL, 2, 'minPlusP', 2, '2011-04-11 07:43:18', '2011-04-11 07:43:18'),
	('4da2b1ea-abd4-4231-bef3-02549be3e0a3', '', '22256950', '3287542', '219796174', NULL, 777, 'minPlusP', 777, '2011-04-11 07:46:50', '2011-04-11 07:46:50'),
	('4da2b1ea-f0e8-4635-b7e9-02549be3e0a3', '', '22256950', '3287542', '219796172', NULL, 777, 'minPlusP', 777, '2011-04-11 07:46:50', '2011-04-11 07:46:50'),
	('4da2b205-21ac-4092-af78-02549be3e0a3', '', '22256950', '3287542', '219796170', NULL, 888, 'minPlusC', 888, '2011-04-11 07:47:17', '2011-04-11 07:47:17'),
	('4da2b205-6710-4f42-9d49-02549be3e0a3', '', '22256950', '3287542', '219796168', NULL, 888, 'minPlusC', 888, '2011-04-11 07:47:17', '2011-04-11 07:47:17'),
	('4da2b205-e018-440a-9171-02549be3e0a3', '', '22256950', '3287542', '219796176', NULL, 888, 'minPlusC', 888, '2011-04-11 07:47:17', '2011-04-11 07:47:17'),
	('4da2b48b-2d70-4052-a43f-02549be3e0a3', '', '4335269', '1642647', '44530352', NULL, 3, 'minPlusP', 3, '2011-04-11 07:58:03', '2011-04-11 07:58:03'),
	('4da2b515-aec0-4056-b75c-02549be3e0a3', '', '4333630', '1642647', '44512345', NULL, 2, 'minPlusP', 5, '2011-04-11 08:00:21', '2011-04-11 08:00:21'),
	('4da2b523-7ee4-48f0-8da5-02549be3e0a3', '', '4333630', '1642647', '44512347', NULL, 44, 'minPlusC', 3, '2011-04-11 08:00:42', '2011-04-11 08:00:35');
...
# Dumping data for table yzk.users: ~28 rows (approximately)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `group_id`, `password`, `key`, `email`, `username`, `last_login`, `created`, `modified`) VALUES
	('4d5efa17-34e8-4274-995b-04619be3e0a3', 3, 'c129b324aee662b04eccf68babba85851346dff9', NULL, 'admin@mm.ru', NULL, NULL, '2011-02-19 02:00:39', '2011-02-19 02:18:04'),
	('4d5f015f-86b0-4b91-b79a-045b9be3e0a3', 3, 'c129b324aee662b04eccf68babba85851346dff9', NULL, 'test1@mm.ru', NULL, '2011-05-29 13:04:10', '2011-02-19 02:31:43', '2011-05-29 13:04:10'),
	('4d78f970-384c-48c6-8fd8-05d49be3e0a3', 4, 'ff918f543d523cc7dedac8a28e79a3a409d57f9e', NULL, 'more@more.mon', NULL, NULL, '2011-03-10 16:16:48', '2011-03-10 16:16:48'),
	('4d78fa41-2a50-4609-b04c-05d49be3e0a3', 4, '31310c37e152884444f8a5739bbebcfed5569bde', NULL, 'more2@more.mon', NULL, NULL, '2011-03-10 16:20:17', '2011-03-10 16:20:17'),
	('4d78faa5-7b40-40e7-8453-05d49be3e0a3', 4, 'aac3665877247873bb07a3f039e638bc9d19c5b0', NULL, 'tml@mm.ru', NULL, NULL, '2011-03-10 16:21:57', '2011-03-10 16:21:57'),
	('4d790b45-b414-4e72-99fc-07d89be3e0a3', 4, '66dfc853703f47c27b2dace60ab41a0b267c1fc0', NULL, 'sdf@mm.lo', NULL, NULL, '2011-03-10 17:32:53', '2011-03-10 17:32:53'),
	('4d790bf4-2288-4462-be70-07d89be3e0a3', 4, 'bec3e835ffd9d8beb3cb9aa89a54a140a69c1ba3', NULL, 'herro@mm.ru', NULL, NULL, '2011-03-10 17:35:48', '2011-03-10 17:35:48'),
	('4d790e74-587c-43cb-ac12-07d89be3e0a3', 4, '506a4f71c5cb8713f22edaccda0ea2339c57cb73', NULL, 'mm@p1.ru', NULL, NULL, '2011-03-10 17:46:28', '2011-03-10 17:46:28'),
	('4d790f31-f95c-468e-804d-07d89be3e0a3', 4, 'd84953c7d45629d4dcf4491c12129cbae7f485a0', NULL, 'hh@vvv.ru', NULL, NULL, '2011-03-10 17:49:37', '2011-03-10 17:49:37'),
	('4d790f7a-aa08-42e0-8be0-07d89be3e0a3', 4, '1e63f9483078b78eb0f86c7e36ff0e965d2141e7', NULL, 'w2w@mm.ru', NULL, NULL, '2011-03-10 17:50:50', '2011-03-10 17:50:50'),
	('4d791332-49fc-46ab-93e2-07d89be3e0a3', 4, 'c15ebe7b5cd7e1978042e8111cbd1f610f3383a5', NULL, 'get@and.com', NULL, NULL, '2011-03-10 18:06:42', '2011-03-10 18:06:42'),
	('4d7913dd-5564-4286-a0e7-07d89be3e0a3', 4, '5979117337d42d00065d73bf1dc95c541d51b959', NULL, 'sup@mpu.ko', NULL, NULL, '2011-03-10 18:09:33', '2011-03-10 18:09:33'),
	('4d79143d-5f0c-4b4d-9e93-07d89be3e0a3', 4, '46473f0dcb8ea420037a620362759ae297907316', NULL, 'mm@bag.ol', NULL, NULL, '2011-03-10 18:11:09', '2011-03-10 18:11:09'),
	('4d7916f1-a834-462a-9541-07d89be3e0a3', 4, '47afe01244909d95ef001690ab08636a3f89f156', NULL, 'last@one.ru', NULL, NULL, '2011-03-10 18:22:41', '2011-03-10 18:22:41'),
	('4d7917de-dccc-48a4-8546-07d89be3e0a3', 4, '2483badd57045fc558ceb49a525a3d73e43e52d6', NULL, 'got@it.ti', NULL, NULL, '2011-03-10 18:26:38', '2011-03-10 18:26:38'),
	('4d79183d-310c-4a4f-8d40-07d89be3e0a3', 4, 'aac694a24fb5c74e7b94019669f88fc7d754d7e9', NULL, 'super@lat.lo', NULL, NULL, '2011-03-10 18:28:13', '2011-03-10 18:28:13'),
	('4d7918fe-fa4c-4a05-88d0-07d89be3e0a3', 4, '39dd3918905d6b4494cb6a995cf3b88c60cb13ad', NULL, 'prob@colb.ru', NULL, NULL, '2011-03-10 18:31:26', '2011-03-10 18:31:26'),
	('4d79197c-3da0-4760-b9e2-07d89be3e0a3', 4, 'c129b324aee662b04eccf68babba85851346dff9', NULL, 'gus@mm.ru', NULL, NULL, '2011-03-10 18:33:32', '2011-03-10 18:33:32'),
	('4d7936bc-26e4-4de3-a925-07d89be3e0a3', 4, 'c129b324aee662b04eccf68babba85851346dff9', NULL, 'goo@mm.na', NULL, NULL, '2011-03-10 20:38:20', '2011-03-10 20:38:20'),
	('4d79375b-28cc-4634-b3b0-07d89be3e0a3', 4, 'c129b324aee662b04eccf68babba85851346dff9', NULL, 'to@create.mo', NULL, NULL, '2011-03-10 20:40:59', '2011-03-10 20:40:59'),
	('4d79c48e-bc68-41fe-ba1b-05449be3e0a3', 4, 'c129b324aee662b04eccf68babba85851346dff9', NULL, 'almet@gem.ru', NULL, '2011-03-11 07:12:06', '2011-03-11 06:43:26', '2011-03-11 07:12:06'),
	('4d877db9-0458-43e6-9b39-025c9be3e0a3', 4, 'c129b324aee662b04eccf68babba85851346dff9', NULL, 'just@for.test', NULL, NULL, '2011-03-21 16:32:57', '2011-03-21 16:32:57'),
	('4d87a347-bae8-4efe-b0c3-025c9be3e0a3', 4, 'c129b324aee662b04eccf68babba85851346dff9', NULL, 'reg@me.lp', NULL, NULL, '2011-03-21 19:13:11', '2011-03-21 19:13:11'),
	('4d87a438-d168-4acc-91f5-025c9be3e0a3', 4, 'c129b324aee662b04eccf68babba85851346dff9', NULL, 'med@med.ru', NULL, NULL, '2011-03-21 19:17:12', '2011-03-21 19:17:12'),
	('4d87a48a-e504-4e87-a3bc-025c9be3e0a3', 4, 'c129b324aee662b04eccf68babba85851346dff9', NULL, 'sv@sv.so', NULL, NULL, '2011-03-21 19:18:34', '2011-03-21 19:18:34'),
	('4d87a979-2b58-4da5-8604-025c9be3e0a3', 4, 'c129b324aee662b04eccf68babba85851346dff9', NULL, 'ddd@mm.ru', NULL, '2011-03-29 15:40:59', '2011-03-21 19:39:37', '2011-03-29 15:40:59'),
	('4d87aa60-ce3c-4297-81a9-025c9be3e0a3', 4, 'c129b324aee662b04eccf68babba85851346dff9', NULL, 'reg2@mm.ru', NULL, '2011-03-22 16:24:01', '2011-03-21 19:43:28', '2011-03-22 16:24:01'),
	('4d87ab98-43f8-41e4-92b1-025c9be3e0a3', 4, 'c129b324aee662b04eccf68babba85851346dff9', NULL, 'hello@mm.kk', NULL, '2011-04-11 06:05:29', '2011-03-21 19:48:40', '2011-04-11 06:05:29');
